...
namespace Tumugu
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            // Markdown 読み込み
            var orgMarkdown = File.ReadAllText(@"C:\Develop\WpfStartSample\WpfStartSample\Doc\Readme.md");
            MarkdownTextBox.Text = orgMarkdown;
        ...
        private async void MarkdownTextBox_TextChanged(object sender, System.Windows.Controls.TextChangedEventArgs e)
        {
            //// Markdig を使う場合の変換
            //var pipeline = new MarkdownPipelineBuilder().UseAdvancedExtensions().Build();
            //var htmlBody = Markdown.ToHtml(MarkdownTextBox.Text, pipeline);
